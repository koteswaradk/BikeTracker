...
public class BluetoothHeadset {
	...
	/**
	 * * Close the connection to the backing service. * Other public functions
	 * of BluetoothHeadset will return default error * results once close() has
	 * been called. Multiple invocations of close() * are ok.
	 */
