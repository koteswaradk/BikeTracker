...
public class RemindersDbAdapter {
     ...
     */
    public long createReminder(String vname,String remabout, String reminderDateTime, String remindernote) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(VEHCLE_NAME, vname);
        initialValues.put(REMIND_ABOUT, remabout);
        initialValues.put(KEY_DATE_TIME, reminderDateTime); 
        initialValues.put(KEY_NOTE, remindernote);
    ...
    public Cursor fetchAllReminders() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, VEHCLE_NAME,
                REMIND_ABOUT, KEY_DATE_TIME,KEY_NOTE}, null, null, null, null, null);
    }
    ...
    public Cursor fetchReminder(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                        VEHCLE_NAME, REMIND_ABOUT, KEY_DATE_TIME}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateReminder(long rowId, String title, String body, String reminderDateTime,String remindernote) {
        ContentValues args = new ContentValues();
        args.put(VEHCLE_NAME, title);
        args.put(REMIND_ABOUT, body);
        args.put(KEY_DATE_TIME, reminderDateTime);
        args.put(KEY_NOTE, remindernote);
