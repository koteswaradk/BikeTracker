...
public class UpdateLIcenceDetails extends Activity implements OnClickListener, OnItemSelectedListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		titlebar.setText("Update Your Licence Details");
		...
		owner_name_et.setFocusable(false);
		...
		father_name_s_w_d_et.setText(licencelist.get(1).toString());
		date_of_birth_et.setText(licencelist.get(2).toString());
		vehiclecat_spinner.setTag(licencelist.get(3).toString());
		...
		valide_from_date_et.setText(licencelist.get(9).toString());
		calss_of_vehcle_spinner.setTag(licencelist.get(10).toString());
		...
		licence_with_effect_date_et.setText(licencelist.get(13).toString());
			...
			Toast.makeText(UpdateLIcenceDetails.this, "licence detail not added", Toast.LENGTH_SHORT).show();
			finish();
		...
		case R.id.ok_button:
			...
			
			{
				...
				AlertDialog alertDialog = new AlertDialog.Builder(
						UpdateLIcenceDetails.this).create();
			...
			alertDialog.setButton("Yes", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					dh=new DataHelper(UpdateLIcenceDetails.this);
							dh.open();
							boolean insertcheck=dh.updatelicencedetails(owner_name_et_s, father_name_s_w_d_et_s, date_of_birth_et_s, catogory_s,blood_group_et_s,
							...
							dh.close();
							if (insertcheck) {
								Toast.makeText(getApplicationContext(), "Licence Detail is updated Success Fully...", Toast.LENGTH_LONG).show();
								finish();
								
							}else {
								
								Toast.makeText(getApplicationContext(), "Sorry your  Detail is Not  updated...", Toast.LENGTH_LONG).show();
