...
public class ExpencesDateDisplay extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.expencesdatedisplay);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		startActivity(bikename);*/
		 ...
		 DataHelper db=new DataHelper(ExpencesDateDisplay.this);
		 db.open();
	      al= db.getBikExpencesDetails(date);
		 db.close();
		 if (al.isEmpty()) {
			 Toast.makeText(ExpencesDateDisplay.this, "expences for the is not added", Toast.LENGTH_SHORT).show();
			
		}else{
		 final AlertDialog builder = new AlertDialog.Builder(ExpencesDateDisplay.this).create();
		 View  layout=new View(ExpencesDateDisplay.this);	
		 LayoutInflater inflater=LayoutInflater.from(ExpencesDateDisplay.this);
		   ...
		   System.out.println(al);
			 ...
			 if(!al.isEmpty()){
				 ...
				 Toast.makeText(ExpencesDateDisplay.this, "Expence setails is not added", Toast.LENGTH_SHORT).show();
					builder.dismiss();
			 }
