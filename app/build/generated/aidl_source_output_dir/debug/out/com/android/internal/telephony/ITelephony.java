...
public interface ITelephony extends android.os.IInterface
{
  ...
  public static class Default implements com.android.internal.telephony.ITelephony
  {
    ...
    @Override public void replaySms() throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements com.android.internal.telephony.ITelephony
  {
    ...
    private static class Proxy implements com.android.internal.telephony.ITelephony
    {
      ...
      @Override public void replaySms() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_replaySms, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().replaySms();
            return;
          }
          _reply.readException();
        }
    ...
    static final int TRANSACTION_replaySms = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
  ...
  public void replaySms() throws android.os.RemoteException;
}
